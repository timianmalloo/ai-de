...
tags: [terminal, conpty, conhost, straggler, census, reap-stragglers, job-object, observability, terminal-stop, dc-131, dc-123, dc-117, dc-154, dc-155, windows-terminal, copilot, mcp]
links:
...
**Two classes, registered as DC-154 and DC-155; DC-131 gains recurrence 4.**

**DC-154 — A resource acquired for a child is released with the owner, not with the child.** The
...
- `WebSurfaceHost` (WebView2 browser processes per surface) was not swept for DC-154.
