...
catalog + menu builder (new entry, kept in sync — DC-044) → announcer status (existing). No new field
...
| Command missing from the menu | Caught by the menu-conformance tests (DC-044) before merge. |
