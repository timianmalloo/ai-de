...
| `tools/regenerate-derived.py` after the audit entry `al-01M2BT3TRC7RR7F6GGZ6GPF2HD` (7,064 s measured) | every derived view current; 14 site figures verified; the register 171 classes + five placeholders (`DC-172–176`, allocated at the join) |
