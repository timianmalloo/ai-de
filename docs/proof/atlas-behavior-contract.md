...
The original design target is `design-atlas-behavior-views`, at
`docs/design/atlas-behavior-views.md` in exact source commit
`5d361f2a9de2ebdcc7a255d33ad31d96a3a2e0f1`. That design document is absent from this
