...
| SC8 | inside a turn, Tab reaches provenance · compiled prompt · events · the turn's actions | … provenance · compiled prompt · **each reasoning disclosure · each tool item's detail (or its group line)** · events · the turn's actions, in DOM order. |
