...
/// <summary>
/// One node's content for the reader/viewer — the client mirror of ADR-0018's <c>NodeContent</c>. Bounded:
...
/// <summary>
/// A stand-in content source until Core ships <c>NodeContentAsync</c> (ADR-0018 Phase 1). It returns a
...
public sealed class MockNodeContentSource : INodeContentSource
{
    ...
    {
        var sample =
            "// SAMPLE — awaiting Core's NodeContentAsync query (ADR-0018).\n" +
