...
public sealed class ClassDiagramSurface : ContentControl
{
    ...
    /// <summary>Builds the hierarchy from a graph and renders it (ADR-0026 class-diagram-architecture).</summary>
    ...
    // The visual diagram (ADR-0026 class-diagram-architecture): types as boxes, generalization/realization as UML connectors with a
