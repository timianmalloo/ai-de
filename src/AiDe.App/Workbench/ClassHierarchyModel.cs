...
/// <summary>A UML relationship kind we derive from the graph (ADR-0026 class-diagram-architecture).</summary>
...
/// <summary>A type in the class diagram — a class or interface. Members are not available yet (ADR-0026 class-diagram-architecture).</summary>
...
/// <summary>Builds a <see cref="ClassHierarchy"/> from graph nodes and edges (ADR-0026 class-diagram-architecture Phase 1).</summary>
